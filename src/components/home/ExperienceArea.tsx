...
const experiences = [
  {
    ...
    description:
      "Building and optimizing high-performance mobile applications using React Native. Focusing on scalability and user experience.",
  },
  {
    year: "Apr 2024 - Mar 2025",
    company: "Edyyo Digital Solutions",
    role: "Freelance Software Developer",
    description:
      "Helping businesses design, develop, and maintain custom web and app solutions tailored to their goals. Turning requirements into scalable applications.",
  },
  {
    ...
    role: "Software Developer",
    description:
      "Developed enterprise-grade applications using React, JavaScript, and Typescript, focusing on scalable and maintainable solutions.",
  },
  {
    ...
    description:
      "Built and optimized the official website using React, implementing performance improvements and responsive layouts.",
  },
  {
    ...
    description:
      "Bachelor's In Information Technology. Built a strong foundation in data structures, algorithms, and core software engineering principles.",
  },
];

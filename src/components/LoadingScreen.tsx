            ...
            {loading && (
                ...
                >
                    <div className="relative">
                        ...
                        >
                            <img src="/assets/images/portfolio.png" alt="Logo" className="w-20 opacity-80" />
                    ...
                    <div className="absolute inset-0 pointer-events-none overflow-hidden">
                        <div className="w-full h-[2px] bg-primary/20 absolute top-0 animate-scan" style={{ boxShadow: '0 0 15px var(--theme-primary, #0B563D)' }} />
                    </div>
                </motion.div>
            )}
        </AnimatePresence>
